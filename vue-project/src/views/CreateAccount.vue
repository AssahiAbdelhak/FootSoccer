<template>
    <div class="p-4 flex justify-center ">
        ...
        <input value="CREER UN COMPTE" type="submit" class="bg-blue-500 mt-4 w-full mb-5 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" />
                ...
                <div v-if="error" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" :class="error ? 'block' : 'hidden'" role="alert">
                    <strong class="font-bold">Erreur! </strong>
                    <span class="block sm:inline ml-5">{{error}}</span>
